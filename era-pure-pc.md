## There Is No Such Thing as an “Era-Pure” Home Gaming PC
...
1. A PC was bought to run the advertised software
2. Current games worked well enough
3. By Christmas a new and more demanding game appeared
4. Performance became too slow
5. Parts were upgraded, starting with the graphics subsystem 
...
* Pentium MMX upgraded from VGA card, to a VGA card plus a Voodoo
* K6‑2 upgraded from a TNT to a GeForce
* Pentium II upgraded from a GeForce2 MX to a later Radeon
...
### 1. The Display Computer

* Never changed
* Exactly as sold
* Good for shop displays
* Shows marketing intent

### 2. The Home Computer

* Software installed including games
* Hardware swapped  when needed
* Changes driven by entertainment desires
* Shows how people  used computers at home

### 3. The Office Computer

* Hardware often not upgraded
* Used for stable  tasks like document editing
...
## Computers Change Over Time

Instead of one perfect moment, a computer moves through different states:

* **Factory state**: As it was boxed
* **Early use**: Set up and explored
* **Lived‑in**: Upgraded, patched, and adapted
* **Aspirational**: What users wanted it to become
* **Anachronistic**: Old hardware pushed further for fun or learning
